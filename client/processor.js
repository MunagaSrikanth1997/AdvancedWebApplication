...
var renderInvestmentPortfolio = async () => {
    console.log("investmentportfolio...................................................................");
    var history = new Map();
    var labelList = [];
    var dataSet = [];
    var portfolioData = [];
    await fetch("http://localhost:8080/getInvestmentportfolio",
        {
            method: "GET"
    ...
    await fetch("http://localhost:8080/getTransactionsHistory",
        {
            ...
            history.forEach((value, key, map) => {
                ...
                value.forEach(transaction => {
                    ...
                    para.innerHTML = transaction.TransactionName + "<br>" + transaction.AccountNumber + "<br>" +"Amount  $ "+ transaction.Amount + "<br>";
